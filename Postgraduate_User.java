...
public class Postgraduate_User extends User
{
    float diplom_grade;
    String faculty;
    String type_of_study;
    
    public Postgraduate_User(String username, String password,float diplom_grade,String faculty,String type_of_study)
    {
